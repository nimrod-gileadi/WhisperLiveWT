...
class TranscriptionServer:
    ...
    def __init__(self):
        self.client_manager = ClientManager(max_connection_time=8*24*3600)
...
class ServeClientBase(object):
    ...
    def __init__(self, client_uid, websocket):
        ...
        # Audio frames to process, separated by eos events.
    ...
    def add_frames(self, frame_np):
        ...
        """
        self.lock.acquire()
        # TODO: Handle the buffer being too large.
    ...
    def add_eos(self):
        # Move current frame to sequence of frames to transcribe.
        frames_np = None
        self.lock.acquire()
        if self.frames_np is not None:
            logging.info("No voice activity detected. Adding frame for transcription.")
            frames_np = self.frames_np
            self.frames_np = None
        self.lock.release()
        if frames_np is not None:
            self.frames_queue.put(frames_np)
    ...
    def get_audio_chunk_for_processing(self):
        ...
        """
        input_bytes = self.frames_queue.get()
...
class ServeClientFasterWhisper(ServeClientBase):
    ...
    def handle_transcription_output(self, result, duration):
        ...
        """
        segments = self.update_segments(result, duration)
