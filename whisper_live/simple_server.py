"""A fork of server, that waits for a whole chunk to be recorded before transcription."""
...
class ClientManager:
    def __init__(self, max_clients=4, max_connection_time=1859):
        """
...
class TranscriptionServer:
    ...
    def handle_new_connection(self, websocket, faster_whisper_custom_model_path):
        try:
            ...
            if self.use_vad:
                self.vad_detector = SimpleVoiceActivityDetector(frame_rate=self.RATE)
...
class ServeClientFasterWhisper(ServeClientBase):
    ...
    def speech_to_text(self):
        ...
        while True:
            ...
            input_sample, duration, chunks = self.get_audio_chunk_for_processing()
